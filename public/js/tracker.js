...
const gainOneEl = document.getElementById('gainOne');
const gainTwoEl = document.getElementById('gainTwo');
const loseOneEl = document.getElementById('loseOne');
const loseTwoEl = document.getElementById('loseTwo');
